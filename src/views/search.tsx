...
export function searchView() {
  return (
    <div className="space-y-6">
      ...
      <GlassPanel><div className="flex flex-col items-center py-20 text-gold-100/30"><Search size={48} className="mb-3" /><p className="font-heading">ฟีเจอร์อยู่ระหว่างพัฒนา</p><p className="text-sm mt-1">ระบบค้นหาข้อมูลทั้งหมด</p></div></GlassPanel>
    </div>
  )
}